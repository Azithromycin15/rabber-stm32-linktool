...
// Never ask me about why I made this plugin loader to use for so many junk files
// In actually EVEN I don't what should I do when firstly I made this
// If some One can help me rebuild this loader application to make it better yo use
// I will be so glad to see that
// On my gosh this is really shit.
// Damn it this fucking piece of shit is truly writen by myself fuck it fuck it fuck it...
